...
usage <- paste(
  ...
  "",
  "Options:",
  "  --phase08-dir DIR          Default: results/minerva_production/08_deg_fine",
  "  --annotation-dir DIR       Default: results/minerva_production/09_annotate_genes",
  "  --network-root DIR         Default: data/bayesian_network",
  "  --output-dir DIR           Default: results/minerva_production/12_rosmap_sex_apoe_mito_kda_runs/inputs",
...
cli <- parse_kda_cli(
  ...
  flag_options = "force",
  defaults = list(
    "phase08-dir" = "results/minerva_production/08_deg_fine",
    "annotation-dir" = "results/minerva_production/09_annotate_genes",
    "network-root" = "data/bayesian_network",
    "output-dir" = "results/minerva_production/12_rosmap_sex_apoe_mito_kda_runs/inputs",
