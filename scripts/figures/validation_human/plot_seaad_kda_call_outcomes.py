#!/usr/bin/env python3
"""Render the historical directional VH10 KDA outcome figure.

This Phase 18-parity workflow is deprecated for current reporting. Current
direction-combined figures are generated by
``scripts/presentations/update_sex_apoe_kda_combo_slides.py --figures-only``.
"""
