...
The principal supporting files are the [circular-figure data](../../results/figures/analysis/phase12_kda (deprecated)/circular_figure/phase12_kda_circular_plotted_data.tsv), the [Phase 12 result rows](../../results/minerva_production/12_rosmap_sex_apoe_mito_kda_runs/kda_results.tsv), the [tested-gene annotation table](../../results/minerva_production/03_annotations/tested_gene_universe.tsv), and the [alias map](../../results/minerva_production/03_annotations/gene_alias_mapping.tsv).
