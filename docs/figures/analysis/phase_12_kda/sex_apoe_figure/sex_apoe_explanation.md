...
The exact values are available in the [plotted-data table](../../../../../results/figures/analysis/phase12_kda (deprecated)/sex_apoe_figure/phase12_kda_sex_apoe_plotted_data.tsv), with the full definitions in the [figure design document](sex_apoe_dot_heatmap_design.md).
