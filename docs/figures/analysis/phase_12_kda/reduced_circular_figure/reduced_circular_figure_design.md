...
```text
results/figures/analysis/phase12_kda (deprecated)/circular_figure/phase12_kda_circular.png
```
...
```text
results/figures/analysis/phase12_kda (deprecated)/reduced_circular_figure/
