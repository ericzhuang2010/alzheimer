...
- Candidate coverage: at least 0.80
- Aggregate ACAT BH q: at most 0.05
- Result tier:
...
| SEA-AD passing and selected candidate units | 11 |
| SEA-AD unique selected genes | 9 |
...
SEA-AD selected five additional units not strictly rediscovered in ROSMAP:
`MT-ND4`, `MT-ATP6`, `HGSNAT`, `BEX3`, and `RPS27A`.
...
| Excitatory neurons | MT | 2 | `MT-CYB` | 5.71e-05 |
| Excitatory neurons | MT | 3 | `MT-ND4` | 0.0309 |
| Excitatory neurons | MT | 4 | `MT-ATP6` | 0.0309 |
| Excitatory neurons | non-MT | 1 | `HGSNAT` | 0.0217 |
| Inhibitory neurons | MT | 1 | `MT-CO2` | 1.60e-11 |
| Inhibitory neurons | MT | 2 | `MT-ND5` | 3.50e-06 |
| Inhibitory neurons | MT | 3 | `MT-CO3` | 6.84e-05 |
| Inhibitory neurons | MT | 4 | `MT-CYB` | 7.18e-05 |
| Inhibitory neurons | non-MT | 1 | `BEX3` | 0.00586 |
| Inhibitory neurons | non-MT | 2 | `RPS27A` | 0.00830 |

All 11 selected units have coverage 1.0. Relative to the overwritten
coverage-0.50/q-0.10 result, the q<=0.05 gate removed `MT-ND1`, `RPL30`,
and `KANSL1L`; the coverage>=0.80 gate removed none. A top-five list was not
forced when fewer than five candidates passed.
...
drivers: it selected `HGSNAT`, `BEX3`, and `RPS27A`, but none matched a
frozen ROSMAP non-MT top-five gene in the same broad network.
...
- The 42 raw KDA call outputs were reused unchanged; no DEG fit or R KDA call was rerun.
- VH10C independently recomputed 11 passing units using coverage>=0.80,
  aggregate q<=0.05, and at least one conservative supporting run.
