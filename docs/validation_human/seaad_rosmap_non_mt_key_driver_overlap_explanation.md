...
> **Historical diagnostic note (superseded 2026-08-23):** The body below was
> written for an overwritten SEA-AD tier and is not a current result. The
> current non-MT selection is summarized in [vh09_vh10_execution_summary.md](vh09_vh10_execution_summary.md).
