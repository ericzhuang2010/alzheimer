...
def test_plot_data_preserves_scope_and_interpretive_categories() -> None:
    source = ROOT / "results/minerva_production/19_genetic_support_tier1 (deprecated)"
...
def test_full_figure_package(tmp_path: Path) -> None:
    ...
    subprocess.run(
        [
            ...
            "--input-root", str(ROOT / "results/minerva_production/19_genetic_support_tier1 (deprecated)"),
